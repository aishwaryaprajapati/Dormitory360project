...
.btn:hover {
  ...
  <form action="AddHouse2.jsp" class="container">
    <h1>AddHouse</h1>

    <label for="email"><b>Owner Name</b></label>
    &nbsp;&nbsp;
    &nbsp;&nbsp;
    
    <input type="text" placeholder="Enter Name" name="un1">
    <br>
    <label for="psw"><b> Enter Email</b></label>&nbsp;
    
    &nbsp;&nbsp;&nbsp;
    &nbsp;&nbsp;
   
    <input type="email" placeholder="Enter Email" name="un10">
    <br>
    ...
    &nbsp;&nbsp;
    &nbsp; &nbsp;&nbsp;
    <input type="text" placeholder="Enter Address" name="un2">
    <br>
    <label><b>City</b></label>&nbsp;
    &nbsp;&nbsp;&nbsp;
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    &nbsp; &nbsp;&nbsp;&nbsp;
    <input type="text" placeholder="Enter City" name="un3">
    <br>
     <label for="email"><b>TypeOfHouse</b></label>    &nbsp;
    &nbsp;
    
    <input type="text" placeholder="Enter Type" name="un4">
    <br>
     <label ><b>Contact No.</b></label>
      &nbsp;&nbsp; &nbsp;&nbsp;
    <input type="number" placeholder="Contact No." name="un5">
    <br>
      <label ><b>Optional No.</b></label>
      &nbsp;&nbsp; &nbsp;
    <input type="number" placeholder="Contact No." name="un6">
    <br>
    ...
    &nbsp;&nbsp; &nbsp;
    &nbsp;&nbsp;
    <input type="number" placeholder="Rent." name="un7">
    <br>
    <label for="email"><b>Extra Facilities</b></label>
    <input type="text" placeholder="Facilities." name="un8">
    <br>
    <label for="email"><b>House Id</b></label>
    &nbsp;&nbsp; &nbsp;
    &nbsp;&nbsp;&nbsp;&nbsp;
    <input type="number" placeholder="Enter Id." name="un9">
    <br>
    ...
    if(s11!=null){
        ...
        <%=s11%>
        <%}%>
    <button type="submit" class="btn">AddHouse</button>
    <br><br>

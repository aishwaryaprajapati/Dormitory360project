...
.bg-img {
  /* The image used */
  background-image: url("https://images.unsplash.com/photo-1598928506311-c55ded91a20c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80");
...
.btn:hover {
  opacity: 1;
    ...
    <body>
      ...
      <ul>
        ...
        <li class="nav-item">
          <a class="nav-link disabled">Client</a>
        </li>
        <li class="nav-item">
        ...
        <form action="ClientLogin2.jsp" class="container">
    <h1>Client Login</h1>
 ...
 <% String s11=request.getParameter("s1");
    ...
    <a href="ClientSignUp.jsp"><button type="button" class="btn" >SignUp</button></a>

...
.bg-img {
  /* The image used */
  background-image: url('https://images8.alphacoders.com/595/595107.jpg');
...
.btn:hover {
  opacity: 1;
    ...
    <body>
      ...
      <ul>
        ...
        <div class="bg-img">
            ...
            <form action="OwnerSignUp.jsp" class="container" onsubmit="return demo1()" method="get">
    <h1>Owner SignUp</h1>
    ...
    &nbsp;
    &nbsp;
    <input type="email" placeholder="Enter Email" name="un1" id="x1">
    <br>
